...
class ServerlessFullstackPlugin {
  constructor(serverless, cliOptions) {
    ...
    this.hooks = {
      ...
      "before:aws:package:finalize:mergeCustomProviderResources":
        this.checkForApiGataway.bind(this),
    };
      ...
      return this.validateConfig()
        .then(() => {
          ...
          if (
            ...
            this.options.noDeleteContents !== true
          ) {
            deployDescribe.push(
              ...
              .then((exists) => {
                if (exists) {
                  ...
                  if (
                    ...
                    this.serverless.cli.log(
                      `Keeping current bucket contents...`
                    );
                    return BbPromise.resolve();
                  }
  ...
  removeApiGatewayOrigin(baseResources) {
    this.serverless.cli.log(
      `ApiGatewayRestApi not found, removing origin from CloudFront...`
    );
  ...
  prepareOrigins(distributionConfig) {
    ...
    if (customOrigins) {
      distributionConfig.Origins.push(...customOrigins);
    }
  }
  ...
  preparePathPattern(distributionConfig) {
    ...
    if (customCacheBehaviors) {
      distributionConfig.CacheBehaviors.push(...customCacheBehaviors);
    }
  }
  ...
  prepareS3(resources) {
    ...
    resources.WebAppS3Bucket.Properties.WebsiteConfiguration.IndexDocument =
      indexDocument;
    resources.WebAppS3Bucket.Properties.WebsiteConfiguration.ErrorDocument =
      errorDocument;
  }
